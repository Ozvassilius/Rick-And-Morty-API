...
/* on crée une extension car on sera surement amené a telecharger une image
 plusieurs donc plutot que de creer une fonction que l'on va dupliquer plusieurs fois,
 on crée une seule fonction dans l'extension qu'on pourra utiliser de partout */
