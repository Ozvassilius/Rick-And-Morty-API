...
class PersoCell: UICollectionViewCell {
    ...
    func setupCell(_ perso : Personnage) {
        ...
        holderView.clipsToBounds = true // sans ca il n'y a que le haut avec le label d'arrondi car l'image n'est pas arrondi, on force que la holdiew soit donc arrondie
    }
}
